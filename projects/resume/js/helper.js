...
var HTMLemail = '<li class="flex-item"><span class="blue-text">email:</span><a href="mailto:jcoto.contact@gmail.com"><span class="white-text">%data%</span></a></li>';
var HTMLtwitter = '<li class="flex-item"><span class="blue-text">twitter:</span><a target="_blank" href="https://twitter.com/jcoto"><span class="white-text">%data%</span></a></li>';
var HTMLgithub = '<li class="flex-item"><span class="blue-text">github:</span><a target="_blank" href="https://github.com/jlcoto"><span class="white-text">%data%</span></a></li>';
var HTMLblog = '<li class="flex-item"><span class="blue-text">blog:</span><a target="_blank" href="http://jose-coto.com/"><span class="white-text">%data%</span></a></li>';
...
var HTMLworkDescription = '</br>%data%';
...
var HTMLprojectSkills = '<div class="project-skills">Skills: %data%.</div>';
...
var HTMLschoolCourses = '<br>Selected Courses: %data%.';
...
var HTMLonlineCourses = 'Selected Courses: %data%.';
